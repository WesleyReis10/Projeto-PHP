...
@section('content')
                ...
                <div class="card-body">
                    <div class="col-lg-3">
                        <div class="small-box bg-success">
                            ...
                            <a href="/marca/nova" class="small-box-footer">Clique aqui <i
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <table class="table table-striped" id="tabelamarca">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($marcas as $marca)
                                <tr>
                                    <td class="ocultarmobile">{{ $marca->id }}</td>
                                    <td>{{ $marca->nome }}</td>
                                    <td style="text-align: right; width: 25%;">
                                        <a href="{{ route('marcaeditar', $marca->id) }}"
                                            class="btn btn-primary">Editar</a>
                                        <button type="button" class="btn btn-danger" data-toggle="modal"
                                            data-target="#deleteModal" data-id="{{ $marca->id }}">
                                            Deletar
                                        </button>
                                    </td>
                                </tr>
