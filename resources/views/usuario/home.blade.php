                ...
                <div class="card-body">
                    <div class="col-lg-3">
                        <div class="small-box bg-success">
                            ...
                            <a href="/usuario/nova" class="small-box-footer">Clique aqui <i
                    ...
                    <table class="table table-striped" id="tabelausuario">
                        ...
                        <tbody>
                            @foreach ($usuarios as $usuario)
                                <tr>
                                    <td class="ocultarmobile">{{ $usuario->id }}</td>
                                    <td>{{ $usuario->email }}</td>
                                    <td>{{ $usuario->nome }}</td>
                                    <td>{{ $usuario->nivel_acesso }}</td>
                                    <td style="text-align: right; width: 25%;">
                                        <a href="{{ route('usuarioeditar', $usuario->id) }}"
                                            class="btn btn-primary">Editar</a>
                                        <button type="button" class="btn btn-danger" data-toggle="modal"
                                            data-target="#deleteModal" data-id="{{ $usuario->id }}">
                                            Deletar
                                        </button>
                                    </td>
                                </tr>
